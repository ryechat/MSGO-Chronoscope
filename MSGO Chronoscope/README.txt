...
●ダウンロード方法
  MSGO Chronoscopeフォルダーの中にMSGO Chronoscope.exeというのがあるのでクリックします。
  .exeをクリックするのってなんか心臓に悪いですが、
  勝手に実行されるなんてことはなくダウンロードページに遷移します。
  Downloadボタンがあるのでそれを押してください。
...
●なにこれ
  ...
  発射位置が５０ｍ以上でないと説明がつかないケースと、
  その弾速ならばもっと早く着弾していないとおかしいケースについては不適格となり、
  代わりにx印を表示します。
